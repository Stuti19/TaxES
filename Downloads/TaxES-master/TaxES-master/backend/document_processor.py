...
class DocumentProcessor:
    ...
    def run_extractors(self):
        ...
        try:
            ...
            if result['status'] == 'success':
                ...
                # Save parsed output directly — skip form16_parser
                with open(self.parsed_dir / "form16_parsed.json", 'w') as f:
        ...
        try:
            ...
            if result['status'] == 'success':
                with open(self.extracted_dir / "passbook_extracted.json", 'w') as f:
                    json.dump(result['data'], f, indent=2)
                # Save parsed output directly — skip passbook_parser
                with open(self.parsed_dir / "passbook_parsed.json", 'w') as f:
                    json.dump(result['parsed'], f, indent=2)
    ...
    def run_parsers(self):
        """Parsers are now handled inside extractors directly"""
        return {'form16_parser': 'skipped (handled in extractor)', 'passbook_parser': 'skipped (handled in extractor)'}
